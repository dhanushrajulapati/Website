...
const Navbar = () => {
  ...
  return (
    <nav className="bg-blue-900 shadow-xl sticky top-0 z-50 ">
...
<div
  className={`
    ...
    absolute top-16 left-0 w-full bg-blue-900  rounded-b-xl
    md:static  md:shadow-none md:rounded-none md:flex md:items-center md:space-0 md:w-auto ml-auto
  `}
>
          ...
          <Link to="/services" className="block py-2 px-3 rounded-lg md:inline text-white no-underline hover:text-blue-300 transition-colors duration-150">Services</Link>
